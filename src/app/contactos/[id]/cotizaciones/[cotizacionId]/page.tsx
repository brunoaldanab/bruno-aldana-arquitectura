  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-xl px-4 py-10">
        <Link href={`/contactos/${id}`} className="text-sm text-neutral-500 hover:text-neutral-100 hover:underline">
          ← Volver al contacto
        </Link>
        <h1 className="font-display mb-6 mt-1 text-3xl font-extralight tracking-[-0.03em] text-neutral-100">{cotizacion.titulo}</h1>
        <CotizacionForm
          action={action}
